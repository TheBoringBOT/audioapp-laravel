<template>
    <div>
        <div class="min-h-screen bg-primary-bg">
            <nav class="bg-secondary-bg border-b border-secondary-bg">
            ...
            <header class="bg-secondary-bg-hover shadow" v-if="$slots.header">
                <div
                    class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 text-primary-clr"
                >
                    <slot name="header" />
                </div>
            </header>
            ...
            <!-- Page Content -->
            <main class="bg-primary-bg text-primary-clr">
                <div
